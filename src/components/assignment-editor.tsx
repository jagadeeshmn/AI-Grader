...
export default function AssignmentEditor({
  ...
  const pageTitle = isEditing ? "Edit Assignment" : "Create New Assignment";
      ...
      <div className="mb-8">
        ...
        {isEditing && assignmentId && (
          <p className="text-muted-foreground mt-2">
            Editing Assignment ID: {assignmentId}
          </p>
        )}
      </div>
            ...
            <div className="space-y-2">
              ...
              >
                <MDEditor
                  ...
                  textareaProps={{
                    placeholder: "Write your assignment content in Markdown...",
